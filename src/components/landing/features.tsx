    ...
    >
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="mt-6 text-muted-foreground text-lg sm:text-xl font-light tracking-wide max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="md:col-span-2 relative group rounded-3xl border border-border bg-card p-8 shadow-2xl flex flex-col justify-between min-h-[320px] transition-all hover:bg-accent">
            ...
            <div className="relative z-10">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-muted/50 border border-border text-foreground mb-6 shadow-sm">
                <Users className="h-5 w-5" />
              </div>
              <h3 className="text-2xl font-bold text-foreground mb-3">
                Multiplayer Collaboration
              </h3>
              <p className="text-muted-foreground text-sm max-w-md leading-relaxed font-light">
            ...
            <div className="mt-8 flex items-center gap-3 border border-border bg-muted/50 rounded-2xl p-2.5 w-fit relative z-10 backdrop-blur-md">
              ...
              <div className="flex -space-x-2 px-2">
                <div className="h-7 w-7 rounded-full border-2 border-background bg-gradient-to-tr from-indigo-500 to-purple-500 flex items-center justify-center text-[10px] text-white font-bold shadow-sm z-30">
                  AL
                </div>
                <div className="h-7 w-7 rounded-full border-2 border-background bg-gradient-to-tr from-emerald-500 to-teal-500 flex items-center justify-center text-[10px] text-white font-bold shadow-sm z-20">
                  SH
                </div>
                <div className="h-7 w-7 rounded-full border-2 border-background bg-gradient-to-tr from-amber-500 to-orange-500 flex items-center justify-center text-[10px] text-white font-bold shadow-sm z-10">
                  JD
                </div>
              </div>
              <div className="h-7 w-7 rounded-full border border-border bg-muted/50 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent cursor-pointer transition-colors shadow-sm ml-1">
          ...
          <div className="relative group rounded-3xl border border-border bg-card p-8 shadow-2xl flex flex-col justify-between min-h-[320px] transition-all hover:bg-accent">
            <GlowingEffect blur={0} borderWidth={3} spread={80} glow={true} disabled={false} proximity={64} inactiveZone={0.01} />
            ...
            <div className="mt-8 relative z-10 w-full h-24 rounded-xl border border-border bg-muted overflow-hidden p-2">
              <div className="w-full h-full border border-border/50 bg-card rounded-lg relative">
                {/* Viewport Box */}
                ...
                <div className="absolute top-3 left-16 w-8 h-4 bg-foreground/10 rounded-[1px]" />
          ...
          <div className="relative group rounded-3xl border border-border bg-card p-8 shadow-2xl flex flex-col justify-between min-h-[320px] transition-all hover:bg-accent">
            ...
            <div className="mt-8 relative z-10 flex flex-col gap-2">
              ...
              <div className="flex items-center justify-between p-2.5 rounded-xl border border-border/50 bg-muted/50 cursor-pointer hover:bg-accent transition-colors">
                <div className="flex items-center gap-2">
                  <div className="h-6 w-6 rounded border border-border bg-muted/50 flex items-center justify-center text-muted-foreground">
                    <Download className="h-3 w-3" />
                  </div>
          ...
          <div className="md:col-span-2 relative group rounded-3xl border border-border bg-card p-8 shadow-2xl flex flex-col justify-between min-h-[320px] transition-all hover:bg-accent">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start justify-between h-full">
              ...
              <div className="w-full sm:w-[280px] md:w-64 shrink-0 rounded-2xl border border-border bg-muted overflow-hidden flex flex-col min-h-[180px] md:h-full mx-auto md:mx-0 mt-2 md:mt-0 shadow-lg">
                ...
                <div className="p-2 space-y-0.5 flex-1">
                  <div className="px-2 py-1.5 flex items-center gap-2 rounded-lg bg-foreground/10 cursor-pointer">
                  ...
                  <div className="px-2 py-1.5 flex items-center justify-between rounded-lg hover:bg-accent cursor-pointer group/item transition-colors">
                    ...
                    <ChevronRight className="h-3 w-3 shrink-0 text-muted-foreground/20 group-hover/item:text-muted-foreground/50" />
                  </div>
                  <div className="px-2 py-1.5 flex items-center justify-between rounded-lg hover:bg-accent cursor-pointer group/item transition-colors">
                    <div className="flex items-center gap-2 overflow-hidden">
